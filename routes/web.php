...
Route::get('/login', [AuthController::class, 'loginRead'])->name('login');
Route::post('/login', [AuthController::class, 'login'])->name('login');
Route::get('/register', [AuthController::class, 'registerRead'])->name('register');
Route::post('/register', [AuthController::class, 'register'])->name('register');
Route::get('/admin', [AuthController::class, 'adminRead'])->name('admin');
